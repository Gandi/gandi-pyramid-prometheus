...
class PromTestCase(TestCase):
    ...
    def test_includeme(self):
        ...
        self.assertIsNone(prom.pyramid_request_inprocess)

        prom.includeme(self.conf)

        self.assertIsNotNone(prom.pyramid_request)
        self.assertIsNotNone(prom.pyramid_request_inprocess)

        self.assertEqual(prom.pyramid_request._type, 'histogram')
        self.assertIsNotNone(prom.pyramid_request_inprocess._type, 'gauge')
